  ...
  return (
    <footer className="border-t border-white/10 bg-slate-950/80">
      <div className="shell grid gap-10 py-14 md:grid-cols-[1.2fr_.8fr_1fr]">
        <div>
          <Logo />
          <p className="mt-5 max-w-md text-sm leading-6 text-slate-400">A direct, payment-first car search across the Oklahoma City metro. One person, one number, no showroom runaround.</p>
      ...
      <div className="border-t border-white/5">
        <div className="shell flex flex-col gap-3 py-6 text-xs leading-5 text-slate-500 sm:flex-row sm:items-start sm:justify-between">
          <p>© {new Date().getFullYear()} NorAuto Match. All rights reserved.</p>
          <p className="max-w-3xl sm:text-right">Vehicle availability and pricing are subject to change. Payment examples are estimates only, exclude taxes and fees, and are not an offer of credit. Vehicle sales, financing, and delivery are completed through an appropriately licensed dealership.</p>
        </div>
      </div>
    </footer>
  );
