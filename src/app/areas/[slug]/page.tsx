...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Payment-first car matching with a direct salesperson at Orr Nissan West for ${city.name}, Oklahoma. Set the number, shortlist the fit, and simplify the drive.`,
...
export default async function AreaPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const localSchema = {
    ...
    provider: { "@type": "AutoDealer", name: brand.dealer.name, telephone: brand.dealer.phoneRaw, url: brand.dealer.url },
