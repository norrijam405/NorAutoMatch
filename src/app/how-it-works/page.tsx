...
const steps = [
  ...
  { icon: Search, title: "Turn an empty deck into a search", text: "No match is not a dead end. It routes your spec and budget into the Vehicle Sourcing pipeline so the regional inventory search can begin." },
  { icon: Handshake, title: "Verify, desk, and deliver", text: "Before any commitment, the exact unit, availability, selling price, taxes, fees, financing terms, and trade are confirmed through Orr Nissan West or the approved licensed selling dealership." },
];
